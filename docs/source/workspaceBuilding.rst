...
.. math::
  ...
  I_0(\theta;x_{-},x_0,x_{+}) = \theta(x_{+} - x_0)` 

for :math:`\theta>=0`, otherwise :math:`\theta(x_0 - x_{-})`. Not recommended except if using a symmetric variation, because of discontinuities in derivatives.
